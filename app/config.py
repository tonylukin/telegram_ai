...
TELEGRAM_IZOLENTA_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN")
TELEGRAM_CHAT_ID = os.getenv("TELEGRAM_CHAT_ID")
APP_HOST = os.getenv("APP_HOST")
TELEGRAM_HUMAN_SCANNER_AI_BOT_TOKEN = os.getenv("TELEGRAM_HUMAN_SCANNER_AI_BOT_TOKEN")
TELEGRAM_FUTURE_ADS_AI_BOT_TOKEN = os.getenv("TELEGRAM_FUTURE_ADS_AI_BOT_TOKEN")
...
TELEGRAM_WHAT_IN_THE_FUTURE_CHAT_ID = os.getenv("TELEGRAM_WHAT_IN_THE_FUTURE_CHAT_ID")
...
TELEGRAM_FUTURE_ADS_NOTIFICATIONS_CHAT_ID = os.getenv("TELEGRAM_FUTURE_ADS_NOTIFICATIONS_CHAT_ID")
TELEGRAM_MOODFLOW_BOT_TOKEN = os.getenv("TELEGRAM_MOODFLOW_BOT_TOKEN")
TELEGRAM_DISHSCAN_BOT_TOKEN = os.getenv("TELEGRAM_DISHSCAN_BOT_TOKEN")
...
TG_TEST_GROUP = config['TG_TEST_GROUP']
PROMOTING_CHANNEL = config['PROMOTING_CHANNEL']
PROMOTING_CHANNEL_TO_INVITE = config['PROMOTING_CHANNEL_TO_INVITE']
AI_SMISHNO_TEXT_PROMPT = config['AI_SMISHNO_TEXT_PROMPT']
AI_SMISHNO_JOKE_ADJECTIVES = config['AI_SMISHNO_JOKE_ADJECTIVES']
AI_WHAT_IN_FUTURE_TEXT_PROMPT = config['AI_WHAT_IN_FUTURE_TEXT_PROMPT']
...
HAIRDRESSER_LEADS_FROM_CHANNEL_AI_PROMPT_CONDITION = config['HAIRDRESSER_LEADS_FROM_CHANNEL_AI_PROMPT_CONDITION']
LEADS_FROM_CHANNEL_AI_SYSTEM_PROMPT = config['LEADS_FROM_CHANNEL_AI_SYSTEM_PROMPT']
CHAT_MESSENGER_DEFAULT_CHANNELS_LIST_CSV_PATH = config['CHAT_MESSENGER_DEFAULT_CHANNELS_LIST_CSV_PATH']
OPEN_AI_TEXT_MODEL = config['OPEN_AI_TEXT_MODEL']
OPEN_AI_IMAGE_MODEL = config['OPEN_AI_IMAGE_MODEL']
